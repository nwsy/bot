...
$edit = bot('sendMessage',[
    ...
    'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                ...
                [['text'=>'Blacklist: '.$cobra2,'callback_data'=>'cobra2']],
             ...
             $cobra1 +=1;
                    if(checkMail($mail) == 1){
                        ...
                        if($verf == "Good"){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "  Hتم الصيد بواسطه هنودي الثكيل🇮🇶💥✅\n━━━━━━━━━━━━\n.卍. UserName: [$usern](instagram.com/$usern)\n.卍. Email: `$mail`\n.卍. Followers: $follow\n.卍. Following: $following\n.卍. Post:  $media\n━━━━━━━━━━━━\nTele:- [@@msxnc]\nCh:- [@@ttemtim]",
